...
export class EmailService {
  ...
  async sendOTP(email: string, otp: string): Promise<void> {
    try {
      const mailOptions = {
        from: env.EMAIL_FROM,
        to: email,
        subject: "Verify Your Email - Curafile",
        html: `
          <!DOCTYPE html>
          <html>
          <head>
  ...
  async sendPasswordResetLink(email: string, resetToken: string): Promise<void> {
    try {
      // Frontend reset password URL (update this based on your frontend URL)
      ...
      const mailOptions = {
        from: env.EMAIL_FROM,
        to: email,
        subject: "Reset Your Password - Curafile",
        html: `
        <!DOCTYPE html>
        <html>
        <head>
